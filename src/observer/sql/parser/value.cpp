...
int Value::compare(const Value &other) const
{
  if (this->attr_type_ == other.attr_type_) {
    ...
    return common::compare_int_char((void *)other.str_value_.c_str(), other.str_value_.length(), (void *)&this->num_value_.int_value_);
  } else if (this->attr_type_ == CHARS && other.attr_type_ == INTS) {
    return common::compare_int_char((void *)this->str_value_.c_str(), this->str_value_.length(), (void *)&other.num_value_.int_value_);
  } else if (this->attr_type_ == FLOATS && other.attr_type_ == CHARS) {
    return common::compare_float_char((void *)other.str_value_.c_str(), other.str_value_.length(), (void *)&this->num_value_.float_value_);
  } else if (this->attr_type_ == CHARS && other.attr_type_ == FLOATS) {
    return common::compare_float_char((void *)this->str_value_.c_str(), this->str_value_.length(), (void *)&other.num_value_.float_value_);
  } 
